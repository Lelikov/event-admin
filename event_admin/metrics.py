"""Prometheus metrics for event-admin.
...
LOGINS_TOTAL = Counter(
    "admin_logins_total",
    "Admin login attempts by outcome (success, failure, blocked).",
    ["outcome"],
)
BLACKLIST_OPS_TOTAL = Counter(
    "admin_blacklist_ops_total",
    "Blacklist CRUD operations by op (create, update, delete).",
    ["op"],
)
